...
The usage can be found in [wake-on-LAN-automatic-tests.md](https://github.com/canonical/checkbox/blob/main/providers/base/units/ethernet/wake-on-LAN-automatic-tests.md)
